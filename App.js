          ...
          <View style={styles.container}>
            <View style={{ flex: 1 }}>
              <Image
                  ...
                  source={{uri: 'https://sun9-42.userapi.com/impg/E92b0aLcMfP8GLjYVFU3BUFgGLbrMzE-009XyQ/5gbqihsqGFw.jpg?size=2560x1707&quality=95&sign=7031a0ddd4650140aff4dc29295a93f6&type=album'}}
              />
            </View>
            <Animatable.Text
            ...
            <FlatList
                ...
                renderItem={({item}) =>
                    <TouchableHighlight style={{position: "relative", marginTop: 5}} onPress={() => navigation.navigate('Swim', {
                      ...
                      <View>
                        <Image source={{uri: item.pic}} style={ {width: deviceWidth, height: 250, flex: 1} }/>
...
function Results ({ navigation }) {
  ...
  return <View>
    <ScrollView>
    <Text style={styles.resultsTitle}>Прошедшие заплывы</Text>
      {isLoading ? <ActivityIndicator size="large" color="#0000ff" style={ {paddingVertical: 10} }/> :
    <FlatList
        scrollEnabled={false}
        data={data}
